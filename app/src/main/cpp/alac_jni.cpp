 ...
 *
 * Backs dev.imirror.receiver.airplay.handshake.AlacDecoder.
 */
#include <jni.h>
#include <cstdint>
#include <cstring>
...
Java_dev_imirror_receiver_airplay_handshake_AlacDecoder_nativeInit(JNIEnv *env, jobject, jbyteArray cookie) {
...
Java_dev_imirror_receiver_airplay_handshake_AlacDecoder_nativeDecode(
...
Java_dev_imirror_receiver_airplay_handshake_AlacDecoder_nativeRelease(JNIEnv *, jobject, jlong handle) {
    if (handle == 0) return;
