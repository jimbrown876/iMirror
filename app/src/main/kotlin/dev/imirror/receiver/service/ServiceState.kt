...
/**
 * ServiceState — Represents the lifecycle state of the MirrorService.
 *
 ...
 *
 * HOW: Emitted by [MirrorService] via a broadcast or LiveData.
 ...
 * emits [ProtocolState] changes that are aggregated by [MirrorService].
 */
