...
/**
 * MirrorApp — The Application class for iMirror.
 *
 ...
 * at startup.
 *
 * HOW: This class is referenced in AndroidManifest.xml via android:name=".MirrorApp".
 ...
 *   The app starts → Android creates MirrorApp → onCreate() runs → Timber is ready.
 */
