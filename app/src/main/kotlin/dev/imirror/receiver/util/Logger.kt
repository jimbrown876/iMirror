package dev.imirror.receiver.util

import timber.log.Timber

/**
 * Logger — A thin wrapper around Timber for iMirror-specific logging.
 *
 * WHY: Using a wrapper instead of calling Timber directly gives us two benefits:
 * 1. We can add iMirror-specific behavior in one place (e.g., scrubbing IP addresses
 ...
 * Timber must be initialized in MirrorApp.onCreate() before Logger is used.
 *
 * Example:
